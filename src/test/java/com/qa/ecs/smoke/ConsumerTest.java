...
public class ConsumerTest extends BaseTest {
	...
	@Test(description = "Verify of Invalid Address Flow and updated Zip Code Flow")
	public void ECS055_ECS056_verifyInvalidAddressAndUpdatedZipCode() {
	...
	public void ECS095_ValidateCollateralDescription() {
		...
		accountDetailTabScreen = customerDetail.clickOnAccountsLink().clickOnPlusIconForAddAccount().clickOnNextButton()
				...
				accountDetailTabScreen.wait(10).expandLinkedCollateralDetailsTableFirstRow();
